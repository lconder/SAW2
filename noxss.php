<html>
    ...
    <center>
        ...
        if (isset($_GET['submit2']) && is_numeric($_GET['dato2'])) {
            $_GET['dato2'] = htmlspecialchars($_GET['dato2']);
        ...
        if (
                isset($_GET['submit3']) &&
                in_array(strtolower($_GET['dato3']), ["rojo", "verde"])
        ) {
        ...
        if (
                isset($_GET['submit4']) &&
                in_array(strtolower($_GET['dato4']), ["blue", "yellow"])
        ) {
